  ...
  return (
    <AboutMeStyles id="aboutMe">
      ...
      <div className="grid">
          ...
          <div className="text">
            <p>Hi, I'm Peter! <span role="img" aria-label="waving hand emoji">👋</span></p>
            <p>I'm born and bred in Melbourne, Australia, with a lifelong passion for working with technology and taking on new challenges <span role="img" aria-label="muscle arm emoji">💪</span>. I have over 8 years experience in technical solutions sales and marketing, and now I’m looking for a new challenge as a front-end developer <span role="img" aria-label="man with laptop emoji">👨‍💻</span>.
            </p>
            ...
            <p>My favorite languages & frameworks I am currently using include JavaScript, React, Gatsby & GraphQL, Node.js & PHP, SCSS / SASS, and AWS serverless technologies (I am both an AWS <a href="https://www.youracclaim.com/badges/8332676d-640f-43cd-92cd-4deb1f36c8bf" alt="AWS developer qualifications page">Certified Developer</a> & <a href="https://www.youracclaim.com/badges/bc0a4983-acb3-426a-90ff-b54341b728f1" alt="AWS SA qualifications page">Solutions Architect</a>).</p>
            <p>In my free time I love travelling <span role="img" aria-label="airplane emoji">✈️</span>, spending time outdoors <span role="img" aria-label="outdoors emoji">🏞️</span>, and keeping fit <span role="img" aria-label="running emoji">🏃</span>. Recently I have been enjoying SUP <span role="img" aria-label="surfing emoji">🏄</span> (Stand-Up Paddleboarding) in the summer, while in the winter I love hot springs! <span role="img" aria-label="hotsprings emoji">♨️</span></p>
        </div>
      </div>
    </AboutMeStyles>
  )
