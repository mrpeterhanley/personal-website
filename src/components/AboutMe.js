...
const AboutMeStyles = styled.div`
    ...
    .text {
        ...
        background-color: rgba(21, 16, 25, 0.7);
    ...
    <AboutMeStyles id="aboutMe">
      ...
      <div className="grid">
          ...
          <div className="text">
            ...
            <p>I'm born and bred in Melbourne, Australia, with a lifelong passion for working with technology and taking on new challenges <span role="img" aria-label="muscle arm emoji">💪</span>. I have over 8 years experience in technical solutions sales and marketing in Asia, and now I'm starting a new journey as a front-end developer <span role="img" aria-label="man with laptop emoji">👨‍💻</span>.
            </p>
            <p>I'm currently working as a front-end developer at <a href="https://fitzroy.it/" alt="Fitzroy IT website">Fitzroy IT</a>. I really enjoy building mobile-responsive websites and web applications that not only implement useful and effective functionality but also are clean & well designed, visually appealing and unique.</p>
