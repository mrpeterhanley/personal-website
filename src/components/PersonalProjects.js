  ...
  const ImageData = useStaticQuery(
    graphql`
        query {
            ...
            loopStudios: file(relativePath: { eq: "loopstudios.jpg" }) {
                childImageSharp {
                    fluid (maxWidth: 300) {
                    ...GatsbyImageSharpFluid_withWebp
                    }
  ...
  return (
    <PersonalProjectStyles id="personalProjects">
      ...
      <div className="projectItems">
        <ProjectItem 
          title='Loop Studios'
          image={ImageData.loopStudios.childImageSharp.fluid}
          description='Solo project - a sample responsive landing page.'
          techItems={['Styled-Components','Gatsby','React','JavaScript']}
          webLink={"https://loopstudios-sample-page.netlify.app/"}
          gitHubLink={"https://github.com/mrpeterhanley/loopstudios-landing-page"}
        />
        <ProjectItem 
          ...
          techItems={['Styled-Components','Typescript','React','JavaScript','Open Weather API']}
        ...
        <ProjectItem 
          ...
          description='Solo project - a restaurant website integrated with a headless CMS (Sanity) via GraphQL.'
          techItems={['Styled-Components','Gatsby','React','GraphQL','Headless CMS']}
        ...
        <ProjectItem 
          ...
          techItems={['React','Material UI','JavaScript','3rd Party API']}
        ...
        <ProjectItem 
          ...
          techItems={['SCSS','React','JavaScript','Webpack']}
